...
namespace ex03.Migrations
{
    ...
    partial class AppDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ex03.Models.Asignado_A", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("ex03.Models.Cientifico", b =>
            {
            ...
            modelBuilder.Entity("ex03.Models.Proyecto", b =>
            {
            ...
            modelBuilder.Entity("ex03.Models.Asignado_A", b =>
            {
                b.HasOne("ex03.Models.Cientifico", "Cientifico")
                    .WithMany("Asignados")
                    .HasForeignKey("CientificoDni")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("ex03.Models.Proyecto", "Proyecto")
                    .WithMany("Asignados")
